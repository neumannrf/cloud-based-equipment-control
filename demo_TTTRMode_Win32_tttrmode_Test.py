...
binning = 0 # you can change this, meaningful only in T3 mode, 0: 4ps resolution
offset = 0 # you can change this, meaningful only in T3 mode
tacq = 30000 # Measurement time in millisec, you can change this
syncDivider = 1 # you can change this, observe mode! READ MANUAL!
CFDZeroCross0 = 10 # you can change this (in mV)
CFDLevel0 =140 # you can change this (in mV)
CFDZeroCross1 = 10 # you can change this (in mV)
CFDLevel1 = 70 # you can change this (in mV)
...
flags = ctypes.c_int()  #current status flags
nactual = ctypes.c_int()  #number of dword(32bit) actually read
ctcDone = ctypes.c_int()  #ctcstatus:0, acquisition time still running 
